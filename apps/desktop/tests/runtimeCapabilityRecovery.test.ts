...
test("runtime failures route exact MCP, shell, database, and model contracts to Settings", () => {
...
test("runtime failure-provided capability ownership takes precedence", () => {
  assert.equal(
