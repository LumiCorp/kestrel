...
contractTest("desktop.hermetic", "Desktop workspace validation forwards typed action and suite commands", async () => {
...
contractTest("desktop.hermetic", "Desktop workspace validation rejects ambiguous run targets", async () => {
