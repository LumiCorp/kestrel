          ...
          <>
            ...
            <section className="inspector-section compact-section">
              ...
              {enabledApps.has("weather") ? (
                <p className={`provider-status ${props.weatherCredential?.configured ? "" : "needs-credential"}`}>
                  <span aria-hidden="true" />
                  {props.weatherCredential?.configured ? "Weather fallback ready" : "Weather free provider"}
                </p>
              ) : null}
            </section>
          </>
