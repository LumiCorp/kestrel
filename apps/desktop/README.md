...
- Desktop 0.8.6 is a signed download and the stable OTA target for signed 0.7.0, 0.8.0, and 0.8.5 clients.
...
Desktop update publication has two explicit operator phases for the 0.8.6 release:
...
pnpm run desktop:promote-update -- --version 0.8.6
```
