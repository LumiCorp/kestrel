...
LOCAL_RECEIVING_BUILD_REVISION="$(git -C "$ROOT_DIR/../.." rev-parse --verify 'HEAD^{commit}' 2>/dev/null || true)"
LOCAL_RECEIVING_BUILD_REVISION="${LOCAL_RECEIVING_BUILD_REVISION:-${KESTREL_BUILD_REVISION:-development}}"
export KESTREL_EMAIL_RECEIVING_RELEASE_EVIDENCE_REVISION="${KESTREL_EMAIL_RECEIVING_RELEASE_EVIDENCE_REVISION:-$LOCAL_RECEIVING_BUILD_REVISION}"
export KESTREL_EMAIL_RECEIVING_SECURITY_REVIEW_REVISION="${KESTREL_EMAIL_RECEIVING_SECURITY_REVIEW_REVISION:-$LOCAL_RECEIVING_BUILD_REVISION}"
