...
export const KESTREL_ONE_ROUTE_OWNERSHIP_MANIFEST = [
  ...
  api(
    "app/api/runtime/executions/[executionId]/authorization/renew/route.ts",
    "/api/runtime/executions/:executionId/authorization/renew",
    "credential-boundary",
    "service-boundary",
    "service-bearer",
  ),
  api(
    "app/api/runtime/environment-runtime/versions/route.ts",
    "/api/runtime/environment-runtime/versions",
    "environments",
    "service-boundary",
    "service-bearer",
  ),
  api(
    "app/api/runtime/environment-runtime/versions/[id]/canary/route.ts",
    "/api/runtime/environment-runtime/versions/:id/canary",
    "environments",
    "service-boundary",
    "service-bearer",
  ),
  api(
    "app/api/runtime/environment-runtime/versions/[id]/promote/route.ts",
    "/api/runtime/environment-runtime/versions/:id/promote",
    "environments",
    "service-boundary",
    "service-bearer",
  ),
  ...
  api(
    "app/api/organization/environments/[id]/runtime-updates/route.ts",
    "/api/organization/environments/:id/runtime-updates",
    ADMIN_API.owner,
    ADMIN_API.access,
    ADMIN_API.unauthorized,
  ),
  ...
  api(
    "app/api/admin/runtime-channel/route.ts",
    "/api/admin/runtime-channel",
    ADMIN_API.owner,
    ADMIN_API.access,
    ADMIN_API.unauthorized,
  ),
