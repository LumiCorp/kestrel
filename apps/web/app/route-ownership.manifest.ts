...
export const KESTREL_ONE_ROUTE_OWNERSHIP_MANIFEST = [
  ...
  api(
    "app/api/kestrel/tools/files/search/route.ts",
    "/api/kestrel/tools/files/search",
    "tool-boundary",
    "tool-boundary",
    "service-bearer",
  ),
  api(
    "app/api/kestrel/tools/files/open/route.ts",
  ...
  api(
    "app/api/files/[fileId]/grants/route.ts",
  ...
  api(
    "app/api/attachments/[attachmentId]/content/route.ts",
  ...
  api(
    "app/api/threads/[id]/attachments/route.ts",
  ...
  api(
    "app/api/threads/[id]/attachments/[attachmentId]/route.ts",
    "/api/threads/:id/attachments/:attachmentId",
    "files",
    AUTHENTICATED_API.access,
    AUTHENTICATED_API.unauthorized,
  ),
  api(
    "app/api/threads/[id]/attachments/[attachmentId]/content/route.ts",
