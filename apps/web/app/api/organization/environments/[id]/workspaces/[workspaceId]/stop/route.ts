...
import { requestWorkspaceStop } from "@/lib/environments/store";
...
export async function POST(
  ...
  try {
    ...
    const operation = await requestWorkspaceStop({
      organizationId,
      environmentId,
      workspaceId,
    ...
    await logAdminEvent({
      ...
      category: "workspaces",
      action: "workspace.stop.requested",
      targetType: "workspace",
      targetId: workspaceId,
      message: "Requested Workspace stop; its machine and volume are retained.",
