...
import type { DbArtifactSuggestion } from "@/lib/knowledge/db-types";

export interface UISuggestion extends DbArtifactSuggestion {
...
export function projectWithPositions(
  doc: Node,
  suggestions: DbArtifactSuggestion[]
): UISuggestion[] {
