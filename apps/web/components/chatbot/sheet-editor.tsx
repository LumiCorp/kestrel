...
const PureSpreadsheetEditor = ({ content, saveContent }: SheetEditorProps) => {
  ...
  const columns = useMemo(() => {
    const rowNumberColumn = {
      ...
      cellClass: "border-t border-r bg-code text-code-foreground",
      headerCellClass: "border-t border-r bg-code-highlight text-code-foreground",
    };
    ...
    const dataColumns = Array.from({ length: MIN_COLS }, (_, i) => ({
      ...
      width: 120,
      cellClass: cn("border-t bg-code text-code-foreground", {
        "border-l": i !== 0,
      }),
      headerCellClass: cn("border-t bg-code-highlight text-code-foreground", {
        "border-l": i !== 0,
      }),
    }));
