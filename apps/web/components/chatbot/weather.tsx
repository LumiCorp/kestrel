...
export function Weather({
  ...
  const currentWeatherTime = new Date(weatherAtLocation.current.time);
        ...
        <div className="rounded-xl bg-white/10 p-3 backdrop-blur-sm">
          ...
          <div className="flex justify-between gap-1">
            {displayTimes.map((time, index) => {
              ...
              const isCurrentHour =
                hourTime.getHours() === currentWeatherTime.getHours() &&
                hourTime.getDate() === currentWeatherTime.getDate();
