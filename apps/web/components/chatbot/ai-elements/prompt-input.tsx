...
import {
  ...
  CommandList,
  CommandSeparator,
} from "@/components/chatbot/ui/command";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
import {
  ...
  HoverCardContent,
  HoverCardTrigger,
} from "@/components/chatbot/ui/hover-card";
import {
  InputGroup,
  InputGroupAddon,
  InputGroupButton,
  InputGroupTextarea,
} from "@/components/chatbot/ui/input-group";
import {
  Select,
  SelectContent,
  SelectItem,
...
export const PromptInputSpeechButton = ({
  ...
  }, [disabled, recognition, isListening, textareaRef]);
