  ...
  ({
    ...
    useEffect(() => {
      if (
        ...
        isOpen &&
        !hasAutoClosedRef &&
        shouldAutoCloseReasoning(terminalStatus)
      ) {
    ...
    return (
      <ReasoningContext.Provider
        value={{ isStreaming, isOpen, setIsOpen, duration, terminalStatus }}
      >
        <Collapsible
...
export const ReasoningTrigger = memo(
  ({ className, children, ...props }: ReasoningTriggerProps) => {
    const { isStreaming, isOpen, duration, terminalStatus } = useReasoning();
