...
test("settings-owned modules use the shared cardless settings surface", () => {
  const files = [
...
test("organization, platform, and personal settings retain separate navigation scopes", () => {
  ...
  const connectionsPage = read("app/(workspace)/settings/connections/page.tsx");
  const githubConnection = read("components/apps/github-connection-card.tsx");
...
test("legacy platform routes permanently redirect to canonical owners", () => {
  const redirects = [
    ...
    ["app/admin/releases/page.tsx", "/platform/operations"],
    ...
    ["app/(workspace)/settings/platform/users/page.tsx", "/platform/users"],
    [
      "app/(workspace)/settings/platform/signup-codes/page.tsx",
      "/platform/signup-codes",
    ],
    ["app/(workspace)/settings/platform/email/page.tsx", "/platform/email"],
  ] as const;
...
test("legacy organization routes permanently redirect to canonical owners", () => {
  const routePairs = [
    ...
    ["organization/ai-providers/page.tsx", "organization/connections/page.tsx"],
