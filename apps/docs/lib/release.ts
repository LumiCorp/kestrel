export const DOCS_RELEASE = {
  ...
  products: {
    cli: {
      ...
      npmVersion: "0.8.2",
      installCommand: "npm install -g @kestrel-agents/kestrel@0.8.2",
  ...
  compatibility: [
    ...
    { surface: "CLI", version: "0.8.0", channel: "Stable", note: "Install the 0.8.2 npm artifact on macOS arm64 or Linux x64 with Node.js 22; the standalone archive remains 0.8.0" },
