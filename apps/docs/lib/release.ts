export const DOCS_RELEASE = {
  ...
  products: {
    cli: {
      ...
      npmVersion: "0.8.5",
      installCommand: "npm install -g @kestrel-agents/kestrel@0.8.5",
      releasesUrl: "https://github.com/LumiCorp/kestrel/releases/tag/v0.8.5",
      archiveUrl: "https://github.com/LumiCorp/kestrel/releases/download/v0.8.5/kestrel-cli-0.8.5-darwin-arm64.tar.gz",
    ...
    kestrelOne: {
      ...
      sourceUrl: "https://github.com/LumiCorp/kestrel/tree/v0.8.5/apps/web",
      hostedAccess: "Invitation",
      accessNote: "Kestrel One 0.8.5 source is available from the release tag. The Lumi-hosted service remains available to invited teams.",
    },
  },
  compatibility: [
    ...
    { surface: "Memory", version: "0.8.5", channel: "Stable", note: "Provides governed memory contracts, backends, and retrieval helpers" },
    { surface: "Next.js", version: "0.8.5", channel: "Stable", note: "Adapts SDK results to server routes" },
