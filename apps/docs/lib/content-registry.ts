...
const curatedPages: RegisteredPageSpec[] = [
  ...
  page("reference/compatibility", "reference/compatibility.mdx", { sourceRefs: ["package.json", "packages/protocol/package.json", "packages/sdk/package.json", "packages/next/package.json", "packages/ai-sdk/package.json", "packages/observability/package.json"], related: ["reference/releases", "build/upgrading-to-0-6"], priority: 96 }),
