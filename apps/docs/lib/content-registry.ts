...
const curatedPages: RegisteredPageSpec[] = [
  ...
  page("operate/production-delivery", "operate/production-delivery.mdx", { sourceRefs: ["docs/production-delivery-channels.md", "apps/preview-edge/ROLLOUT.md", "deploy/fly/kestrel-one-turn-worker/ROLLOUT.md", "deploy/fly/kestrel-one-control-worker/ROLLOUT.md", "deploy/fly/kestrel-one-runpod-worker/ROLLOUT.md", "deploy/fly/kestrel-one-runner/ROLLOUT.md", "apps/web/vercel.json", "scripts/publish-production-image.ts", "scripts/deploy-production-fly-machine.ts", "apps/web/scripts/update-environment-runtime.ts"], archetype: "operational-playbook", experienceLevel: "advanced", related: ["operate/deployment", "operate/migrations", "kestrel-one/production-operations"], priority: 95, capabilities: ["production delivery", "migrations"] }),
