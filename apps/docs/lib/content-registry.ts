...
const curatedPages: RegisteredPageSpec[] = [
  ...
  page("operate/production-delivery", "operate/production-delivery.mdx", { sourceRefs: ["docs/production-delivery-channels.md", ".github/workflows/production-database.yml", ".github/workflows/production-fly.yml", ".github/workflows/production-runpod.yml"], archetype: "operational-playbook", experienceLevel: "advanced", related: ["operate/deployment", "operate/migrations", "kestrel-one/production-operations"], priority: 95, capabilities: ["production delivery", "migrations"] }),
