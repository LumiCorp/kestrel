...
const curatedPages: RegisteredPageSpec[] = [
  ...
  page("operate/production-delivery", "operate/production-delivery.mdx", { sourceRefs: ["docs/production-delivery-channels.md", "apps/web/vercel.json", ".github/workflows/production-fly.yml", ".github/workflows/production-runtime.yml", ".github/workflows/production-runpod.yml", "apps/web/app/api/internal/production-images/route.ts"], archetype: "operational-playbook", experienceLevel: "advanced", related: ["operate/deployment", "operate/migrations", "kestrel-one/production-operations"], priority: 95, capabilities: ["production delivery", "migrations"] }),
