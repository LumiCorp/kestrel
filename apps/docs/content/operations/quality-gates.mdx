...
Pack all eight public packages, inspect contents and exact internal pins, and install them into a clean external consumer. Release evidence also covers CLI archives/checksums, signed Desktop artifacts, deployment revision/digests, and registry metadata.
