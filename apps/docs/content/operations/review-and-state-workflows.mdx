...
summary: Inspect task graph and project projections, mutate project Git state, and apply project review actions from the browser or SDK when a run becomes larger than a transcript.
section: operate
