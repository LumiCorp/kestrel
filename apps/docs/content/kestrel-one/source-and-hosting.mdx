...
Clone the repository and check out [`v0.8.5`](https://github.com/LumiCorp/kestrel/tree/v0.8.5/apps/web). The `apps/web` manifest is private because Kestrel One is not published as an npm application package; it still carries the product version.
