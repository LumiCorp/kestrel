...
Install `@kestrel-agents/kestrel@0.8.0` globally with npm on a release-verified platform, open the intended project directory, and start the TUI.
...
- The CLI/TUI reports `0.8.0`, becomes ready, and finishes one bounded project task.
