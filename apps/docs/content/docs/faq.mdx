...
Release verification covers macOS arm64 and Linux x64 with Node.js 22. Install it with `npm install -g @kestrel-agents/kestrel@0.8.0`. Other platforms are not release-verified for 0.8.
