...
Kestrel One is currently available to invited teams. Use the invitation from your organization administrator. Public signup and self-hosted consumer onboarding are not currently documented.
