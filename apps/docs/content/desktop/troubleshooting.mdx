...
| Manual upgrade reports the wrong version | Applications copy, release checksum, and running process identity | Quit Kestrel and reinstall the exact signed 0.8.4 application |

## Application and LaunchServices

Verify macOS 13+, Apple silicon, the release checksum, Developer ID signature, notarization, and that the application running from Applications is the 0.8.4 copy.
