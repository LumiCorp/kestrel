...
Kestrel 0.8 is an exact-contract upgrade. Use the versions in the compatibility matrix together: Runtime 0.8.7 consumes the exact 0.8.5 Protocol, Conversation, Files, SDK, Memory, and Workspace Skills packages, while the other public adapters remain 0.8.5.
