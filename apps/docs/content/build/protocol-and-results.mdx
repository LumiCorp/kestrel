...
Runtime, Protocol, SDK, adapters, and clients must use the exact matching 0.8 line. Kestrel does not add a 0.7 wire or API shim around removed project actions.
