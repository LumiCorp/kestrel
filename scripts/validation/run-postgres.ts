...
const files = execFileSync(
  ...
  .concat(
    ...
    "apps/web/lib/email/receiving-deletion-fence.postgres.test.ts",
    "apps/web/lib/email/receiving-route-replacement.postgres.test.ts",
    "apps/web/lib/email/receiving-webhook-reconciliation.postgres.test.ts",
    "apps/web/lib/email/receiving-webhook-staging.postgres.test.ts",
    "apps/web/lib/organizations/deletion-receiving.postgres.test.ts",
    "apps/web/lib/email-receipts/ingress.postgres.test.ts",
    "apps/web/lib/email-receipts/runtime.postgres.test.ts",
...
const groups = [
  {
    ...
    files: [
      ...
      "lib/integrations/hosted-personal-oauth.postgres.test.ts",
      ...
      "lib/email/receiving-webhook-staging.postgres.test.ts",
      "lib/organizations/deletion-receiving.postgres.test.ts",
  ...
  },
  {
    ...
    files: [
      ...
      "lib/workflows/store.postgres.test.ts",
