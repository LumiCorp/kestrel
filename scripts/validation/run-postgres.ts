...
const files = execFileSync(
  ...
  .concat(
    ...
    "apps/web/lib/environments/provider-persistence.postgres.test.ts",
    "apps/web/lib/environments/kubernetes-connector.postgres.test.ts",
...
const groups = [
  ...
  },
  {
    ...
    files: [
      ...
      "lib/environments/kubernetes-connector.postgres.test.ts",
      "lib/environments/provider-persistence.postgres.test.ts",
