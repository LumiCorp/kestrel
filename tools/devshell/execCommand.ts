...
function readSourceMutation(body: Record<string, unknown>): "reject" | "capture" | undefined {
  const requestedMutation = readString(body, "sourceMutation");
  if (requestedMutation === undefined) return;
