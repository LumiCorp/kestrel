...
export const BUILT_IN_TOOL_INPUT_CONTRACTS = {
  ...
  "kestrel_one.gmail_search_messages": { mode: "schema-only" },
  "kestrel_one.gmail_get_message": { mode: "schema-only" },
  "kestrel_one.gmail_get_thread": { mode: "schema-only" },
  "kestrel_one.gmail_import_attachment": { mode: "schema-only" },
  "kestrel_one.gmail_send_message": { mode: "schema-only" },
  "kestrel_one.gmail_reply_message": { mode: "schema-only" },
  "kestrel_one.email_send": { mode: "schema-only" },
  "kestrel_one.microsoft_365_list_mail": { mode: "schema-only" },
  "kestrel_one.microsoft_365_send_mail": { mode: "schema-only" },
  "kestrel_one.microsoft_365_list_events": { mode: "schema-only" },
  "kestrel_one.microsoft_365_list_chats": { mode: "schema-only" },
  "kestrel_one.microsoft_365_list_chat_messages": { mode: "schema-only" },
  "kestrel_one.microsoft_365_send_chat_message": { mode: "schema-only" },
  "kestrel_one.microsoft_365_search_sites": { mode: "schema-only" },
  "microsoft_365.list_mail": { mode: "schema-only" },
  "microsoft_365.send_mail": { mode: "schema-only" },
  "microsoft_365.list_events": { mode: "schema-only" },
  "microsoft_365.list_chats": { mode: "schema-only" },
  "microsoft_365.list_chat_messages": { mode: "schema-only" },
  "microsoft_365.send_chat_message": { mode: "schema-only" },
  "microsoft_365.search_sites": { mode: "schema-only" },
  "google_workspace.list_events": { mode: "schema-only" },
  "google_workspace.create_event": { mode: "schema-only" },
  "google_workspace.update_event": { mode: "schema-only" },
  "google_workspace.delete_event": { mode: "schema-only" },
  "google_workspace.search_gmail": { mode: "schema-only" },
  "google_workspace.get_gmail_message": { mode: "schema-only" },
  "google_workspace.get_gmail_thread": { mode: "schema-only" },
  "google_workspace.import_gmail_attachment": { mode: "schema-only" },
  "google_workspace.send_gmail": { mode: "schema-only" },
  "google_workspace.reply_gmail": { mode: "schema-only" },
