...
contractTest("runtime.hermetic", "fresh user turns clear stale goal and evidence state", () => {
...
contractTest("runtime.hermetic", "fresh user turns clear stale loop-stall control state", () => {
