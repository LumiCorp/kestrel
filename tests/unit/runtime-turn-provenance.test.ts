  ...
  await store.appendModelCallProvenance({
    ...
    proof: {
      ...
      effectiveContract: {
        ...
        registrationFingerprint: "registration-fingerprint-a",
        qualificationRevision: "qualification-a",
        apiEndpoint: "https://openrouter.ai/api/v1",
        endpoint: "chat",
        endpointCodec: "openrouter.chat.v2",
        routingPolicyFingerprint: "routing-a",
        runtimeRole: "agent.loop",
        requestFingerprint: "request-a",
        schemaHash: "schema-a",
        toolSurfaceHash: "tools-a",
        fingerprint: "effective-a",
      },
