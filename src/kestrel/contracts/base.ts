...
export type RunEventType =
  ...
  | "run.failed"
  | "run.cancelled"
  | "sandbox_capability.requested"
  | "sandbox_capability.denied"
  | "sandbox_capability.issued"
  | "sandbox_capability.consumed"
  | "sandbox_capability.exhausted"
  | "sandbox_capability.revoked"
  | "sandbox_capability.expired"
  | "sandbox_capability.cancelled"
  | "sandbox_capability.cleaned"
  | "execution_boundary.decision"
  | "sandbox_capability.requested"
  | "sandbox_capability.denied"
  | "sandbox_capability.issued"
  | "sandbox_capability.invoking"
  | "sandbox_capability.consumed"
  | "sandbox_capability.exhausted"
  | "sandbox_capability.revoked"
  | "sandbox_capability.expired"
  ...
  | "model.provenance"
  | "model.completed"
  | "economics.model_call.requested"
  | "economics.model_attempt.started"
  | "economics.model_attempt.completed"
  | "economics.model_attempt.failed"
  | "economics.model_call.completed"
  | "economics.model_call.failed"
  | "economics.tool_result.recorded"
  | "economics.outcome.evaluated"
  | "economics.run_outcome.evaluated"
  | "decision.generated"
  | "decision.compiled"
