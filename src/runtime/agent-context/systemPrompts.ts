...
export const PLAN_MODE_DELIBERATOR_PROMPT = [
  ...
  "4c. Use task.propose without taskId for missing work. Use task.propose with the exact taskId only to revise a matching agent-created task that is still proposed. Include order when the proposal must move to match the latest plan sequence. Never revise approved, active, review, or closed work.",
