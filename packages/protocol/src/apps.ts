...
export const KESTREL_STANDARD_APP_MANIFESTS: readonly AppPluginManifest[] = [
  ...
  p(KESTREL_APP_IDS.LINEAR, "Linear", "Plan, track, and update product and engineering work.", [c("issues", "Issues", "Find and update issues."), c("planning", "Projects and roadmaps", "Read and update projects.")]),
