...
import {
  ...
  WORKSPACE_RUNNER_HEALTH_PROBE_TIMEOUT_SECONDS,
  WORKSPACE_RUNNER_RECOVERY_GRACE_MS,
  WORKSPACE_RUNNER_RECOVERY_GRACE_SECONDS,
  WORKSPACE_RUNNER_RECOVERY_STOP_TIMEOUT_MS,
  WORKSPACE_RUNNER_RECOVERY_STOP_TIMEOUT_SECONDS,
...
test(
  ...
  () => {
    assert.equal(WORKSPACE_RUNNER_HEALTH_PROBE_TIMEOUT_SECONDS, 5);
    assert.equal(WORKSPACE_RUNNER_HEALTH_PROBE_TIMEOUT_MS, 5_000);
    assert.equal(WORKSPACE_RUNNER_RECOVERY_GRACE_SECONDS, 30);
    assert.equal(WORKSPACE_RUNNER_RECOVERY_GRACE_MS, 30_000);
    assert.equal(WORKSPACE_RUNNER_RECOVERY_STOP_TIMEOUT_SECONDS, 10);
    assert.equal(WORKSPACE_RUNNER_RECOVERY_STOP_TIMEOUT_MS, 10_000);
