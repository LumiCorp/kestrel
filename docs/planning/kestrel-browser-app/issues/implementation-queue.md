...
- [Promote a quarantined browser download](08-promote-a-quarantined-browser-download.md) — final transfer-race, expiry, and Desktop restart repairs are green; blocked only on the exact pinned Chrome download-GUID-to-response-media-type protocol decision documented in the issue
