...
- [Carry full-size hosted viewer frames](06d-carry-full-size-hosted-viewer-frames.md) — shared viewer frame bounds, pinned-contract Desktop owned-file capture, and status-aware Router bounds pass 118 focused transport/lifecycle tests plus the exact owned-file regression; awaiting independent review
