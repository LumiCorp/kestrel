...
- [Prove structured output and tool calls before success](02-prove-model-responses.md) — depends on issue 01.
- [Correct OpenAI Chat and Responses codecs](03-correct-openai-codecs.md) — depends on issue 01.
- [Make OpenRouter codecs and routing contract-safe](04-correct-openrouter-codecs-and-routing.md) — depends on issue 01.
- [Use native Anthropic Messages contracts](05-correct-anthropic-codec.md) — depends on issue 01.
...
- [Bind runtime routes to exact model evidence](07-bind-exact-runtime-routes.md) — depends on issue 01.
