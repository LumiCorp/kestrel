...
export const TUI_COMMAND_DESCRIPTORS: readonly TuiCommandDescriptor[] = [
  ...
  { id: "cmd.environment", root: "environment", label: "/environment", detail: "Show and choose the session execution environment", group: "workspace", order: 45, command: "/environment" },
  { id: "cmd.environment.developer", root: "environment", label: "/environment developer", detail: "Use the selected Developer workspace", group: "workspace", order: 46, command: "/environment developer" },
  { id: "cmd.environment.safe", root: "environment", label: "/environment safe", detail: "Use an isolated Safe sandbox", group: "workspace", order: 47, command: "/environment safe" },
