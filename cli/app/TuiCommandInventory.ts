...
export const TUI_COMMAND_DESCRIPTORS: readonly TuiCommandDescriptor[] = [
  ...
  { id: "cmd.skill.status", root: "skill", label: "/skill status", detail: "Show active skill pack constraints", group: "preferences", order: 40, command: "/skill status" },
  { id: "cmd.skill.list", root: "skill", label: "/skill list", detail: "List available skill packs", group: "preferences", order: 41, command: "/skill list" },
  { id: "cmd.skill.clear", root: "skill", label: "/skill clear", detail: "Clear the active skill pack", group: "preferences", order: 42, command: "/skill clear" },
  { id: "draft.skill.use", root: "skill", label: "Insert /skill use template", detail: "Insert a skill-pack template into the composer", group: "templates", order: 60, draft: "/skill use " },
