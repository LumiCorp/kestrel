    ...
    if (subcommand === "policy") {
      ...
      await this.context.appendHistoryLine(
        ...
        [
          ...
          `sandbox workspaceSizeMb=${policy.sandbox.workspaceSizeMb ?? "default"} workspaceInodes=${policy.sandbox.workspaceInodes ?? "default"} tmpSizeMb=${policy.sandbox.tmpSizeMb ?? "default"} tmpInodes=${policy.sandbox.tmpInodes ?? "default"}`,
